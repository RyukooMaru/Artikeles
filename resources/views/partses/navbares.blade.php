  ...
  <div class="right-section">
    @if(session('isLoggedIn'))
        <a href="/profile" title="{{ session('username') }}">
            <img src="{{ session('improfil') ?? 'https://via.placeholder.com/40' }}" alt="Profile" class="profile-img"/>
        </a>
    @else
...
<button class="toggle-mode" onclick="toggleDarkMode()">🌙/☀️</button> <!-- Tombol mode terang/gelap -->
</head>
<body>
...
<button class="toggle-mode" onclick="toggleDarkMode()">🌙/☀️</button> <!-- Tombol mode terang/gelap -->
  ...
  <nav class="sidebar">
    <a href="{{ url('/artikeles') }}" class="nav-item home">
      <img src="https://cdn-icons-png.flaticon.com/128/2932/2932143.png" class="icon-img" alt="Home">
      <span>Home</span>
    </a>

    <a href="{{ url('/buates') }}" class="nav-item create">
      <img src="https://cdn-icons-png.flaticon.com/128/3161/3161837.png" class="icon-img" alt="Buat">
      <span>Buat</span>
    </a>

    <a href="#" class="nav-item settings">
      <img src="https://cdn-icons-png.flaticon.com/128/8138/8138637.png" class="icon-img" alt="Settings">
      <span>Settings</span>
    </a>

    @if(session('isLoggedIn'))
      <a href="{{ url('/logout') }}" class="nav-item logout">
        <img src="https://cdn-icons-png.flaticon.com/128/8944/8944313.png" class="icon-img" alt="Logout">
        <span>Logout</span>
      </a>
    @endif
  </nav>
